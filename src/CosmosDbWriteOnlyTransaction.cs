...
internal class CosmosDbWriteOnlyTransaction : JobStorageTransaction
{
    ...
    public CosmosDbWriteOnlyTransaction(CosmosDbConnection connection) => this.connection = connection ?? throw new ArgumentNullException(nameof(connection));
    ...
    public override void DecrementCounter(string key)
    {
        ...
        QueueCommand(() =>
        {
            Counter data = new() { Key = key, Type = CounterTypes.Raw, Value = -1 };
        ...
        QueueCommand(() =>
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    {
                        PatchOperation.Set("/expire_on", epoch)
                    };
    ...
    public override void InsertToList(string key, string value)
    {
        ...
        QueueCommand(() =>
        {
            List data = new() { Key = key, Value = value, CreatedOn = DateTime.UtcNow };
    ...
    private void ExpireDocuments<T>(int expireOn, string[] records, PartitionKey partitionKey)
    {
        ...
        PatchOperation[] patchOperations =
        {
            PatchOperation.Set("/expire_on", expireOn)
        };
