...
public class CosmosDbConnectionFacts : IClassFixture<ContainerFixture>
{
    ...
    public CosmosDbConnectionFacts(ContainerFixture containerFixture)
    {
    ...
    public void CreateExpiredJob_CreatesAJobInTheStorage_AndSetsItsParameters()
    {
        ...
        IStorageConnection connection = Storage.GetConnection();
        Dictionary<string, string> parameters = new Dictionary<string, string> { { "Key1", "Value1" }, { "Key2", "Value2" }, { "Key3", "Value3" } };
    ...
    public void CreateExpiredJob_CanCreateParametersWithNullValues()
    {
        ...
        DateTime createdAt = new DateTime(2012, 12, 12);
        IStorageConnection connection = Storage.GetConnection();
        Dictionary<string, string?> parameters = new Dictionary<string, string?> { { "Key1", null }, { "Key2", null }, { "Key3", null } };
