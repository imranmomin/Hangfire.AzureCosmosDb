...
public class ExpirationManagerFacts : IClassFixture<ContainerFixture>
{
    ...
    public void Execute_DoesNotRemoveEntries_WithNoExpirationTimeSet()
    {
        ...
        // arrange
        List<Counter> counters = new() { new Counter { Key = "key", Value = 1, Type = CounterTypes.Aggregate }, new Counter { Key = "key", Value = 1, Type = CounterTypes.Aggregate } };
        Data<Counter> data = new(counters);
        Storage.Container.ExecuteUpsertDocuments(data, PartitionKeys.Counter);
    ...
    public void Execute_Processes_JobTable()
    {
        ...
        // arrange
        List<Job> jobs = new() { new Job { CreatedOn = DateTime.UtcNow, ExpireOn = DateTime.UtcNow.AddMonths(-1) }, new Job { CreatedOn = DateTime.UtcNow, ExpireOn = DateTime.UtcNow.AddMonths(-1) } };
        ...
        // assert
        QueryRequestOptions queryRequestOptions = new() { PartitionKey = PartitionKeys.Job };
    ...
    public void Execute_Processes_ListTable()
    {
        ...
        // arrange
        List<List> lists = new() { new List { CreatedOn = DateTime.UtcNow, ExpireOn = DateTime.UtcNow.AddMonths(-1) }, new List { CreatedOn = DateTime.UtcNow, ExpireOn = DateTime.UtcNow.AddMonths(-1) } };
        ...
        // assert
        QueryRequestOptions queryRequestOptions = new() { PartitionKey = PartitionKeys.List };
    ...
    public void Execute_Processes_SetTable()
    {
        ...
        // arrange
        List<Set> sets = new() { new Set { CreatedOn = DateTime.UtcNow, ExpireOn = DateTime.UtcNow.AddMonths(-1) }, new Set { CreatedOn = DateTime.UtcNow, ExpireOn = DateTime.UtcNow.AddMonths(-1) } };
        ...
        // assert
        QueryRequestOptions queryRequestOptions = new() { PartitionKey = PartitionKeys.Set };
    ...
    public void Execute_Processes_HashTable()
    {
        ...
        // arrange
        List<Hash> hashes = new() { new Hash { ExpireOn = DateTime.UtcNow.AddMonths(-1) }, new Hash { ExpireOn = DateTime.UtcNow.AddMonths(-1) } };
    ...
    public void Execute_Processes_StateTable()
    {
        ...
        // arrange
        List<State> states = new() { new State { CreatedOn = DateTime.UtcNow, ExpireOn = DateTime.UtcNow.AddMonths(-1) }, new State { CreatedOn = DateTime.UtcNow, ExpireOn = DateTime.UtcNow.AddMonths(-1) } };
        ...
        // assert
        QueryRequestOptions queryRequestOptions = new() { PartitionKey = PartitionKeys.State };
