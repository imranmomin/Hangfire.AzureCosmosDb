...
public class CosmosDbStorageFacts
{
    ...
    {
        ArgumentNullException exception = Assert.Throws<ArgumentNullException>(() => new CosmosDbStorage(null!, "databaseName", "container"));
...
#pragma warning restore CS0618
    ...
    {
        CosmosClient cosmosClient = new CosmosClient(url, secret);
        return new CosmosDbStorage(cosmosClient, database, container);
    }
}