/**
 * Removes item from set related to key/value
 * @param {ISet} doc - the set doc
 */
function removeFromSet(doc: ISet) {
    ...
    let filter = (d: ISet) => d.type === 7 && d.key === doc.key && d.value === doc.value;
